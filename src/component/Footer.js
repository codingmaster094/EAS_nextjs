        ...
        <div className="f-wrapper py">
          <div className="f-main">
            ...
            <div className="f-menu">
              <ul>
                ...
                <li>
                  <Link href="/pages/unternehmen" aria-label="Unternehmen">
                    UNTERNEHMEN
                  </Link>
                </li>
                <li>
                  <Link href="/pages/team" aria-label="Team">
                    TEAM
                  </Link>
                </li>
                <li>
                  <Link
                    href="/pages/produkt-und-leistungs-portfolio"
                ...
                <li>
                  <Link href="/pages/kontakt" aria-label="Kontakt">
                    KONTAKT
                  </Link>
                </li>
                <li>
                  <Link href="/pages/dokumente" aria-label="Dokumente">
                    DOKUMENTE
                  </Link>
                </li>
              </ul>
          ...
          <div className="f-content">
            ...
            <div className="f-ns-mail">
              <form action="">
                <input type="email" placeholder="Ihre E-Mail eingeben" />
      ...
      <div class="copy-right">
            <div class="container">
                <div class="copy-wrapper">
                    ...
                    <div class="copy-link">
                        <Link href="/" aria-label="">Terms</Link>
                        <Link href="/" aria-label="">Privacy</Link>
                        <Link href="/" aria-label="">Cookies</Link>
                    </div>
                </div>
            </div>
        </div>
